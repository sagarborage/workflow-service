...
CREATE TABLE pro_forma_invoice_item (
  ...
  `optimize_bucket` int(5)  NOT NULL DEFAULT 0,
  `cutting_bucket` int(5)  NOT NULL DEFAULT 0,
  `toughen_bucket` int(5)  NOT NULL DEFAULT 0,
  `dispatch_bucket` int(5)  NOT NULL DEFAULT 0,
  `optimize_completed` int(5)  NOT NULL DEFAULT 0,
  `cutting_completed` int(5)  NOT NULL DEFAULT 0,
  `toughen_completed` int(5)  NOT NULL DEFAULT 0,
  `dispatch_completed` int(5)  NOT NULL DEFAULT 0,
  is_active BOOLEAN NOT NULL DEFAULT 1,
  created_by VARCHAR(64) NOT NULL,
  created_datetime TIMESTAMP NOT NULL DEFAULT (CURRENT_TIMESTAMP),
  last_updated_by VARCHAR(64) NOT NULL,

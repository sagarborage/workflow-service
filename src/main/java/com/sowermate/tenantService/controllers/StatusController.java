...
public class StatusController {
    ...
    public ResponseEntity<StatusValue> getSingleStatus(@PathVariable String tenantUuid,@PathVariable String statusUuid) throws Exception {
    ...
    public ResponseEntity<List<StatusValue>> getAllStatus(@PathVariable String tenantUuid) throws Exception {
    ...
    @ResponseBody
    public ResponseEntity<StatusValue> deleteStatus(@PathVariable String tenantUuid,@PathVariable String statusUuid) throws Exception {

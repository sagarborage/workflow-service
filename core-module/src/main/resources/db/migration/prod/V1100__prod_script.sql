INSERT INTO app_config_settings
    ...
    -- Cors config
    ('cors.allowedOrigins', 'https://workflow.sowermate.com,https://www.workflow.sowermate.com', 'Cors', 'Allowed origins for CORS requests', 1, 'System', NOW(), 'System', NOW(), 1),
    ...
    ('email.send.mode', 'live', 'Notification', 'Email sending mode: live, console, or both', 1, 'System', NOW(), 'System', NOW(), 1),
    ('spring.mail.username', 'noreply@sowermate.com', 'Notification', 'Email sender address', 1, 'System', NOW(), 'System', NOW(), 1),
    ...
    -- UI page URL config
    ('email.confirmation.link', 'https://workflow.sowermate.com/email-verify?token=%s', 'UIPageUrl', 'URL for email confirmation link with token placeholder', 1, 'System', NOW(), 'System', NOW(), 1),
    ('account.confirmation.link', 'https://workflow.sowermate.com/set-password?token=%s', 'UIPageUrl', 'URL for account confirmation page with token', 1, 'System', NOW(), 'System', NOW(), 1),
    ('website.home.page.link', 'https://workflow.sowermate.com/GeneratePassword', 'UIPageUrl', 'URL for website home page', 1, 'System', NOW(), 'System', NOW(), 1),
    ('set.password.page.link.for.forgot.password', 'https://workflow.sowermate.com/reset-password?token=%s', 'UIPageUrl', 'URL for password reset page with token placeholder', 1, 'System', NOW(), 'System', NOW(), 1),

    -- JWT config
    ('authentication.jwt.token.secret', 'workflowprodsecretkey1234567890workflowchprodsecretkey1234567890workflowprodsecretkey1234567890', 'JWT', 'Secret key used for signing JWT tokens', 1, 'System', NOW(), 'System', NOW(), 1),
    ...
    ('is.unprotected.url.token.verification.enabled', 'false', 'Auth', 'Enable or disable token verification for unprotected URLs. If enabled, requests to unprotected endpoints must include a valid token.', 1, 'System', NOW(), 'System', NOW(), 1),

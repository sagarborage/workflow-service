...
import com.sowermate.workflow.service.services.ProFormaInvoiceItemService;
...
public class ProFormaInvoiceItemServiceImpl implements ProFormaInvoiceItemService {
    ...
    @Autowired
    private WorkflowImageStorageConfig imageStorageConfig;
...
//            return "Error when Deleted file";
    ...
    public ProFormaInvoiceItemValue editProFormaInvoiceItem(ProFormaInvoiceItemValue proFormaInvoiceItemValue) {
        ...
        ProFormaInvoiceItemEntity proFormaInvoiceItemEntity = proFormaInvoiceItemValue.toEntity().toBuilder()
                ...
                .heightMeasurementLabel(proFormaInvoiceItemValue.getHeightMeasurementLabel() == null ? tempProFormaInvoiceItemEntity.getHeightMeasurementLabel() : proFormaInvoiceItemValue.getHeightMeasurementLabel())
                .widthMeasurementLabel(proFormaInvoiceItemValue.getWidthMeasurementLabel() == null ? tempProFormaInvoiceItemEntity.getWidthMeasurementLabel() : proFormaInvoiceItemValue.getWidthMeasurementLabel())
        ...
        if (actionType.equals("add")) {
            ...
            switch (DeptTypeEnum.valueOf(deptType.toUpperCase())) {
                ...
                case DISPATCH:
                    ...
                    break;
                default:
                    throw new InvalidInputException("Invalid department type");
            }

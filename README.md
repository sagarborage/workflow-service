...
```
cd existing_repo
git remote add origin https://gitlab.sowermate.com/workflow-automation/workflow-service.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.sowermate.com/workflow-automation/workflow-service/-/settings/integrations)
